...
function calculateProforma() {
  ...
  const noi = multifamilyIncome - expenses;
  ...
  renderProformaTable(multifamilyIncome, expenses, noi, annualDebtService);
}
...
function renderProformaTable(income, expenses, noi, debt) {
  ...
  for (let i = 1; i <= 5; i++) {
    ...
    html += `<tr class="border-t">
      ...
      <td class="px-4 py-2">$${Math.round(debt).toLocaleString()}</td>
